...
{
    public partial class App : IArgosApp
    {
        ...
        public event EventHandler StoresChangedEvent;

        public void StoresChanged()
        {
            if (StoresChangedEvent != null)
                StoresChangedEvent(this, null);
        }
